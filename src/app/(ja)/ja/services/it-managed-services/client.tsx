...
export default function JapaneseITManagedServicesClient() {
  return (
    <main className="bg-white">
      <h1 className="sr-only">東京のマネージドサービス：ビジネスを支えるIT運用</h1>
      {/* ── Mobile / Tablet hero ── */}
      <section id="hero" className="relative overflow-hidden bg-[#02304F] lg:hidden">
        ...
        <div className="relative z-10 flex min-h-[520px] flex-col justify-end px-5 pb-7 sm:min-h-[560px] sm:px-8 sm:pb-9">
          ...
          <p className="font-serif text-[22px] font-light leading-[1.12] tracking-[-0.02em] text-white sm:text-[26px]">
        ...
        <div className="relative flex h-[500px] items-center">
          <div className="mx-auto w-full max-w-[1047px] px-12">
            <div className="max-w-lg xl:max-w-xl">
              ...
              <p className="font-serif text-[30px] font-light leading-[1.15] tracking-[-0.02em] text-white xl:text-[34px]">
                東京のマネージドサービス：ビジネスを支えるIT運用
              </p>
      ...
      <section className="bg-white pb-4 pt-4">
        <div className="mx-auto max-w-[1200px] px-6 lg:px-9">
          <div className="border-t border-[#E4E4EB] px-0 py-10">
            <p className="text-[13px] font-medium uppercase tracking-widest text-[#4E4F5F]/50">関連ガイド</p>
            <h3 className="mt-2 text-[24px] font-light tracking-[-0.01em] text-[#0A0B10]">
              東京の外国人社員向けITサポート：国際社員に必要なサービス
            </h3>
            <p className="mt-3 max-w-3xl text-[16px] leading-[1.6] text-[#4E4F5F]">
              東京で外国人社員にバイリンガルITサポートを提供する方法 — オンボーディング、デバイス設定、継続的なヘルプデスクサービスについて解説します。
            </p>
            <Link
              href="/ja/blog/expat-it-support-tokyo"
