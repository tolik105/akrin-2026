...
export default function ITConsultingProjectManagementJaClient() {
  return (
    <main className="bg-[#F7F7FC]">
      <h1 className="sr-only">ITコンサルティングサービス＆エンタープライズ向けプロジェクト管理</h1>
      {/* ── Mobile / Tablet hero ── */}
          ...
          <section className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="border-t border-[#E2E5EF] py-10">
              ...
              <h3 className="mt-2 text-[22px] font-light tracking-[-0.01em] text-[#0A0B19]">
                オフィス移転ITサポート：ダウンタイムを最小化する方法
              </h3>
              <p className="mt-3 max-w-3xl text-[15px] leading-[1.6] text-[#6B6D7C]">
                日本でのIT移転計画の実践ガイド — ネットワーク移行、ベンダー調整、オフィス移転時の事業継続性について解説します。
              </p>
              <Link
                href="/ja/blog/office-move-it-support-japan"
