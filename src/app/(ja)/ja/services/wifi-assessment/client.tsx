  ...
  const AssessmentIcon = ({ index }: { index: number }) => {
    ...
    switch (index) {
      case 0: // Site Survey & RF Analysis
        return (
          <svg className={`${common} text-[#0A0B19]`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="bg-white font-sans">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
              <div className="text-center lg:text-left">
                <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#2D2E3F] mb-4 sm:mb-6 leading-tight">なぜWi‑Fi評価が<br />重要なのか</h2>
                <p className="text-base sm:text-lg text-[#6B6D7C] mb-6 sm:mb-8 leading-relaxed">無線パフォーマンスの低下は、生産性、ユーザーエクスペリエンス、ビジネス運営に大きな影響を与える可能性があります。プロフェッショナルなWi‑Fi評価は、カバレッジギャップ、干渉問題、最適化の機会を特定し、無線ネットワークが信頼性の高い高性能接続を提供することを確保します。</p>
                <p className="text-base sm:text-lg text-[#6B6D7C] mb-6 sm:mb-8 leading-relaxed">私たちの包括的な評価アプローチは、高度なRF分析、サイト調査、パフォーマンステストを組み合わせて、詳細な洞察と無線インフラストラクチャ最適化のための実用的な推奨事項を提供します。</p>
                <div className="space-y-3 sm:space-y-4">
                  {accordionItems.slice(0,4).map((it, idx) => (
                    <div key={idx} className="flex items-start space-x-3 sm:space-x-4">
                      ...
                      <span className="text-[#2D2E3F] text-sm sm:text-base lg:text-lg leading-relaxed">{it.title}</span>
                    </div>
                  ))}
                </div>
              </div>
        ...
        <div className="bg-white py-12 sm:py-16 lg:py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#2D2E3F] mb-4 sm:mb-6 leading-tight">Wi‑Fi評価機能</h2>
              <p className="text-base sm:text-lg text-[#6B6D7C] max-w-3xl mx-auto leading-relaxed">包括的な無線ネットワーク評価サービスにより、最適なパフォーマンス、セキュリティ、カバレッジを確保します。</p>
            </div>
            <CapabilityCards
        ...
        <div className="bg-[#F8F9FA] py-12 sm:py-16 lg:py-20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-base sm:text-lg text-[#6B6D7C] max-w-2xl mx-auto leading-relaxed">Wi‑Fi評価サービスに関するよくある質問にお答えします。</p>
            </div>
        ...
        <div className="bg-[#0A0B19] py-12 sm:py-16 lg:py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-4 leading-tight">Wi‑Fiネットワークを最適化する準備はできていますか？</h2>
            <p className="text-sm sm:text-base text-white/90 mb-6 max-w-4xl mx-auto leading-relaxed">プロフェッショナルなWi‑Fi評価でネットワークパフォーマンスを向上させましょう。包括的な分析と専門的な推奨事項で無線接続を最適化します。</p>
