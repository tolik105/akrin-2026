...
export const metadata: Metadata = {
  title: 'Ekahau Wireless Surveys in Japan',
  description:
    'Ekahau wireless surveys, RF analysis, AP planning, and FLUKE cable testing for enterprise Wi-Fi environments in Japan.',
  alternates: {
