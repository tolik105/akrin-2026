...
export const metadata: Metadata = {
  title: 'Cloud Infrastructure Services in Japan',
  description:
    'Cloud migration, managed operations, cost optimization, and hybrid cloud support for businesses operating in Japan.',
  alternates: {
