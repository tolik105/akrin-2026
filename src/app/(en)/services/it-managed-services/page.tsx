...
export const metadata: Metadata = {
  title: 'Managed IT Services in Tokyo',
  description:
    '24/7 managed IT support, bilingual help desk, infrastructure management, and security operations for businesses in Japan.',
  alternates: {
