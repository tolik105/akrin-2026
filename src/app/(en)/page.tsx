...
export const metadata: Metadata = {
  title:
    'Managed IT Services Tokyo | IT Support, ITAD & ITAM',
  description:
    'Managed IT services in Tokyo with bilingual support, ITAD, asset management, cybersecurity, and cloud operations for businesses in Japan.',
  openGraph: {
    title:
