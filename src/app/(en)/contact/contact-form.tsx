      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
        ...
        <form onSubmit={handleSubmit} className="px-6 pt-20 pb-24 sm:pb-32 lg:px-8 lg:py-48">
          <div className="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
            {/* Success message */}
            {status === 'success' && (
              <div className="mb-6 rounded-md bg-[#FAFAFC] p-4">
                <p className="text-sm font-medium text-[#0A0B19]/80">
                  {copy.success}
                </p>
              </div>
            )}
              ...
              <div>
                ...
                <div className="mt-2.5">
                  <input
                    ...
                    className="block w-full rounded-md border border-gray-300 bg-white px-3.5 py-2 text-base text-gray-900 placeholder:text-gray-400 focus:border-[#0A0B19] focus:outline-none focus:ring-2 focus:ring-[#0A0B19]/30"
                  />
                </div>
              </div>
              <div>
            ...
            <div className="mt-8 flex justify-end">
              <button
                ...
                className="rounded-md bg-[#0066CC] px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-xs hover:bg-[#0052A3] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#0066CC] disabled:cursor-not-allowed disabled:opacity-50"
              >
