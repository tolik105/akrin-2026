              ...
              <div>
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-start space-x-4">
                    ...
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">Comprehensive project planning and resource management</span>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">Risk assessment and mitigation strategies</span>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">Vendor coordination and stakeholder management</span>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">Quality assurance and delivery oversight</span>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">Post-implementation support and optimization</span>
                  </div>
                </div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="order-1 lg:order-2">
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">Pre-move IT infrastructure assessment and planning</span>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">Network and telecommunications setup at new location</span>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">Equipment relocation and secure data migration</span>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">Testing and validation of all systems</span>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">Employee training and support during transition</span>
                  </div>
                </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-8 mb-16">
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-[#2D2E3F] mb-4">Planning & Design</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-[#2D2E3F] mb-4">Build & Installation</h3>
                <ul className="text-[#6B6D7C] space-y-2 text-left">
                  <li className="flex items-start space-x-2">
                    <div className="w-1.5 h-1.5 bg-[#0A0B19] rounded-full mt-2 flex-shrink-0"></div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-[#2D2E3F] mb-4">Migration & Testing</h3>
                <ul className="text-[#6B6D7C] space-y-2 text-left">
                  <li className="flex items-start space-x-2">
                    <div className="w-1.5 h-1.5 bg-[#0A0B19] rounded-full mt-2 flex-shrink-0"></div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-[#2D2E3F] mb-4">Ongoing Support</h3>
                <ul className="text-[#6B6D7C] space-y-2 text-left">
                  <li className="flex items-start space-x-2">
                    <div className="w-1.5 h-1.5 bg-[#0A0B19] rounded-full mt-2 flex-shrink-0"></div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
              ...
              <div className="bg-white p-8 rounded-lg shadow-sm">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-xl font-bold text-[#2D2E3F]">Assessment Phase</h3>
                </div>
              ...
              <div className="bg-white p-8 rounded-lg shadow-sm">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-xl font-bold text-[#2D2E3F]">Planning Phase</h3>
                </div>
                <ul className="space-y-3 text-[#6B6D7C]">
                  <li className="flex items-start space-x-3">
                    <div className="w-1.5 h-1.5 bg-[#0A0B19] rounded-full mt-2 flex-shrink-0"></div>
              ...
              <div className="bg-white p-8 rounded-lg shadow-sm">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-xl font-bold text-[#2D2E3F]">Implementation</h3>
                </div>
                <ul className="space-y-3 text-[#6B6D7C]">
                  <li className="flex items-start space-x-3">
                    <div className="w-1.5 h-1.5 bg-[#0A0B19] rounded-full mt-2 flex-shrink-0"></div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div>
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">Requirements gathering and stakeholder analysis</span>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">Process mapping and workflow optimization</span>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">Solution design and technical specifications</span>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">Change impact assessment and management</span>
                  </div>
                </div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div>
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">Legacy system migration and modernization</span>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">Cloud migration and hybrid infrastructure</span>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">Technology stack optimization and renewal</span>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">Data migration and integrity validation</span>
                  </div>
                </div>
