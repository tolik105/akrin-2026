          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
              ...
              <div className="text-center lg:text-left">
                <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#2D2E3F] mb-4 sm:mb-6 leading-tight">
                  Security Assessment<br />
                  & Audit
                </h2>
                <p className="text-base sm:text-lg text-[#6B6D7C] mb-6 sm:mb-8 leading-relaxed">
                ...
                <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    ...
                    <span className="text-[#2D2E3F] text-sm sm:text-base lg:text-lg leading-relaxed">Vulnerability assessments and penetration testing</span>
                  </div>
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-2 sm:mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-sm sm:text-base lg:text-lg leading-relaxed">Compliance audits and gap analysis</span>
                  </div>
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-2 sm:mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-sm sm:text-base lg:text-lg leading-relaxed">Risk assessment and prioritization</span>
                  </div>
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-2 sm:mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-sm sm:text-base lg:text-lg leading-relaxed">Security policy development</span>
                  </div>
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-2 sm:mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-sm sm:text-base lg:text-lg leading-relaxed">Remediation planning and implementation</span>
                  </div>
                </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
              ...
              <div className="order-1 lg:order-2 text-center lg:text-left">
                ...
                <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-2 sm:mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-sm sm:text-base lg:text-lg leading-relaxed">24/7 security monitoring and alerting</span>
                  </div>
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-2 sm:mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-sm sm:text-base lg:text-lg leading-relaxed">Advanced threat detection and analysis</span>
                  </div>
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-2 sm:mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-sm sm:text-base lg:text-lg leading-relaxed">Rapid incident response and containment</span>
                  </div>
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-2 sm:mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-sm sm:text-base lg:text-lg leading-relaxed">Threat intelligence and hunting</span>
                  </div>
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-2 sm:mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-sm sm:text-base lg:text-lg leading-relaxed">Forensic analysis and reporting</span>
                  </div>
                </div>
        ...
        <div className="bg-[#F8F9FA] py-12 sm:py-16 lg:py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-base sm:text-lg text-[#6B6D7C] max-w-4xl mx-auto leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mb-12 sm:mb-16">
              ...
              <div className="text-center sm:text-left lg:text-center">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-[#2D2E3F] mb-3 sm:mb-4">Continuous Monitoring</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-[#2D2E3F] mb-4">Threat Analysis</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-[#2D2E3F] mb-4">Incident Response</h3>
                <ul className="text-[#6B6D7C] space-y-2 text-left">
                  <li className="flex items-start space-x-2">
                    <div className="w-1.5 h-1.5 bg-[#0A0B19] rounded-full mt-2 flex-shrink-0"></div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-[#2D2E3F] mb-4">Compliance Management</h3>
                <ul className="text-[#6B6D7C] space-y-2 text-left">
                  <li className="flex items-start space-x-2">
                    <div className="w-1.5 h-1.5 bg-[#0A0B19] rounded-full mt-2 flex-shrink-0"></div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
              ...
              <div className="text-center lg:text-left">
                ...
                <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-2 sm:mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-sm sm:text-base lg:text-lg leading-relaxed">Enterprise-grade security tools and platforms</span>
                  </div>
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-2 sm:mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-sm sm:text-base lg:text-lg leading-relaxed">Certified security professionals</span>
                  </div>
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-2 sm:mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-sm sm:text-base lg:text-lg leading-relaxed">Proven incident response methodologies</span>
                  </div>
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-2 sm:mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-sm sm:text-base lg:text-lg leading-relaxed">Continuous threat landscape monitoring</span>
                  </div>
                </div>
