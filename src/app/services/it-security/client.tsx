              ...
              <div>
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-start space-x-4">
                    ...
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">Advanced antivirus and anti-malware protection</span>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">Device encryption and data protection</span>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">Mobile device management (MDM)</span>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">Remote device monitoring and control</span>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">Compliance and policy enforcement</span>
                  </div>
                </div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="order-1 lg:order-2">
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">Next-generation firewall deployment</span>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">Intrusion detection and prevention systems</span>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">VPN setup and secure remote access</span>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">Network segmentation and access control</span>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">Continuous network monitoring</span>
                  </div>
                </div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div>
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">Multi-layered security approach</span>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">24/7 monitoring and incident response</span>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">Compliance and regulatory support</span>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">Proactive threat management</span>
                  </div>
                </div>
