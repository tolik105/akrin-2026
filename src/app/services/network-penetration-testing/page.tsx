...
export const metadata: Metadata = {
  ...
  description:
    'Professional network penetration testing services in Japan. External and internal pen testing, vulnerability assessment, black box and gray box testing with detailed reporting and remediation guidance.',
  alternates: {
