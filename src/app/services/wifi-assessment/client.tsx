      ...
      <div className="bg-white font-sans">
        ...
        <div className="bg-[#3462BD] py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <Link href="/contact" className="inline-flex items-center justify-center w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-white text-[#3462BD] font-bold text-base sm:text-lg rounded-sm hover:bg-gray-100 transition-all duration-200 shadow-lg hover:shadow-xl">Start Wi‑Fi assessment
