      ...
      <div className="bg-white font-sans">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
              <div className="text-center lg:text-left">
                <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#2D2E3F] mb-4 sm:mb-6 leading-tight">Why Wi‑Fi Assessment<br />Matters</h2>
                ...
                <p className="text-base sm:text-lg text-[#6B6D7C] mb-6 sm:mb-8 leading-relaxed">Our comprehensive assessment approach combines advanced RF analysis, site surveys, and performance testing to provide detailed insights and actionable recommendations for optimizing your wireless infrastructure.</p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
              ...
              <div className="order-1 lg:order-2 text-center lg:text-left">
                <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#2D2E3F] mb-4 sm:mb-6 leading-tight">Your Wi‑Fi Optimization<br />Partner</h2>
                ...
                <p className="text-base sm:text-lg text-[#6B6D7C] leading-relaxed">From initial site surveys to ongoing optimization, we provide the expertise needed to ensure your wireless network delivers consistent, reliable performance that supports your business objectives and user requirements.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#0A0B19] py-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-4 leading-tight">Ready to optimize your Wi‑Fi network?</h2>
            <Link href="/contact" className="inline-flex items-center justify-center w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-white text-[#0A0B19] font-bold text-base sm:text-lg rounded-sm hover:bg-gray-100 transition-all duration-200 shadow-lg hover:shadow-xl">Start Wi‑Fi assessment
