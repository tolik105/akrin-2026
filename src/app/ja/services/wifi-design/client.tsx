    ...
    >
      <div className="flex items-start">
        <div className="relative mr-3 sm:mr-4 mt-1 h-5 w-5 sm:h-6 sm:w-6 flex-shrink-0">
          <svg
            className={cn(
              "absolute inset-0 h-full w-full transform text-[#0A0B19] transition-all duration-200",
          ...
          <svg
            className={cn(
              "absolute inset-0 h-full w-full rotate-90 scale-0 transform text-[#0A0B19] transition-all duration-200",
  ...
  return (
    <div>
      <div className="bg-white font-sans">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
              <div className="text-center lg:text-left">
                <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#2D2E3F] mb-4 sm:mb-6 leading-tight">なぜプロフェッショナルな<br />Wi‑Fi設計が重要なのか</h2>
                <p className="text-base sm:text-lg text-[#6B6D7C] mb-6 sm:mb-8 leading-relaxed">効果的な無線ネットワークには、適切な計画、戦略的設計、専門的な実装が必要です。プロフェッショナルなWi‑Fi設計は、最適なカバレッジ、パフォーマンス、スケーラビリティを確保し、ビジネス要件をサポートし、将来の成長に対応します。</p>
                <p className="text-base sm:text-lg text-[#6B6D7C] mb-6 sm:mb-8 leading-relaxed">私たちの包括的な設計アプローチは、高度なRFモデリング、容量計画、セキュリティ実装を組み合わせて、信頼性が高く効率的で安全な無線ネットワークソリューションを提供します。</p>
                <div className="space-y-3 sm:space-y-4">
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-2 sm:mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-sm sm:text-base lg:text-lg leading-relaxed">予測設計・RFモデリング</span>
                  </div>
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-2 sm:mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-sm sm:text-base lg:text-lg leading-relaxed">戦略的アクセスポイント配置</span>
                  </div>
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-2 sm:mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-sm sm:text-base lg:text-lg leading-relaxed">ネットワークアーキテクチャ設計</span>
                  </div>
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-2 sm:mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-sm sm:text-base lg:text-lg leading-relaxed">容量計画・スケーラビリティ</span>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
              ...
              <div className="order-1 lg:order-2 text-center lg:text-left">
                <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#2D2E3F] mb-4 sm:mb-6 leading-tight">Wi‑Fi設計<br />パートナー</h2>
                <p className="text-base sm:text-lg text-[#6B6D7C] mb-6 sm:mb-8 leading-relaxed">成功する無線ネットワーク設計には、RF原理、ネットワークアーキテクチャ、業界標準の深い理解が必要です。認定された無線設計専門家が最新のツールと方法論を使用して、お客様の特定の要件に合わせた包括的なソリューションを提供します。</p>
                <p className="text-base sm:text-lg text-[#6B6D7C] mb-6 sm:mb-8 leading-relaxed">初期計画から最終実装まで、無線ネットワークがビジネス目標を達成し、ユーザーの期待を上回る一貫した信頼性の高いパフォーマンスを提供することを確保するために必要な専門知識を提供します。</p>
                <div className="space-y-3 sm:space-y-4">
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-2 sm:mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-sm sm:text-base lg:text-lg leading-relaxed">認定無線設計専門家</span>
                  </div>
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-2 sm:mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-sm sm:text-base lg:text-lg leading-relaxed">業界標準設計手法</span>
                  </div>
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-2 sm:mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-sm sm:text-base lg:text-lg leading-relaxed">包括的実装サポート</span>
                  </div>
                  <div className="flex items-start space-x-3 sm:space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-2 sm:mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-sm sm:text-base lg:text-lg leading-relaxed">継続的最適化・サポート</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="bg-[#F8F9FA] py-12 sm:py-16 lg:py-20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#2D2E3F] mb-4 sm:mb-6 leading-tight">よくあるご質問</h2>
              <p className="text-base sm:text-lg text-[#6B6D7C] max-w-2xl mx-auto leading-relaxed">Wi‑Fi設計サービスに関するよくある質問にお答えします。</p>
            </div>
        ...
        {/* Section 4 - CTA */}
        <div className="bg-[#0A0B19] py-12 sm:py-16 lg:py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-4 leading-tight">Wi‑Fiネットワークを設計する準備はできていますか？</h2>
            <p className="text-sm sm:text-base text-white/90 mb-6 max-w-4xl mx-auto leading-relaxed">プロフェッショナルなWi‑Fi設計・実装サービスを受けましょう。ビジネス環境で信頼性の高い高性能無線ネットワークを構築します。</p>
            <Link href="/ja/contact" className="inline-flex items-center px-8 sm:px-12 py-3 sm:py-4 bg-white text-[#0A0B19] font-bold text-lg sm:text-xl rounded-sm hover:bg-gray-100 transition-all duration-200 shadow-lg hover:shadow-xl">
              Wi‑Fi設計開始
