...
export const metadata: Metadata = {
  title: 'Ekahau ワイヤレスサイトサーベイ | Wi-Fiサーベイ・ケーブルテスト — AKRIN',
  description:
    'Ekahauを使用したプロフェッショナルなワイヤレスサイトサーベイ — 予測設計、アクティブ検証、パッシブRF分析、スペクトラム評価、FLUKE認定構造化ケーブリングサービスを提供。エンタープライズWi-Fiネットワーク向け。',
  alternates: {
