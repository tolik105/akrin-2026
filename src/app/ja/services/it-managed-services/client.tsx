...
function ImagePlaceholder({ className = '' }: { className?: string }) {
  return (
    <div
      className={`flex min-h-[260px] items-center justify-center rounded-xl border border-[#0A0B19]/10 bg-white/60 ${className}`}
    >
      {/* IMAGE PLACEHOLDER */}
      <p className="font-mono text-[11px] uppercase tracking-[0.14em] text-[#0A0B19]/40">
        IMAGE PLACEHOLDER
      </p>
    </div>
  )
  ...
  return (
    <main className="bg-[#F7F7FC]">
      <section className="relative overflow-hidden">
        ...
        {/* Mobile: top-to-bottom gradient — image visible at top, solid at bottom where text lives */}
        <div
          aria-hidden="true"
          className="absolute inset-0 bg-gradient-to-b from-transparent via-[#0A0B19]/70 via-40% to-[#0A0B19] lg:hidden"
        />

        {/* Desktop: left-to-right gradient — text on left, image peeks through on right */}
        <div
          aria-hidden="true"
          className="absolute inset-0 hidden lg:block lg:bg-gradient-to-r lg:from-[#0A0B19] lg:via-[#0A0B19]/95 lg:via-45% lg:to-transparent"
        />

        {/* Content — pushed to bottom on mobile, vertically centered on desktop */}
        <div className="relative flex flex-col justify-end pt-36 sm:pt-44 lg:min-h-[440px] lg:justify-end lg:pt-0">
          <div className="mx-auto w-full max-w-7xl px-6 pb-10 sm:pb-12 lg:px-8 lg:py-16">
            ...
            <div className="mt-5 max-w-2xl lg:mt-6">
              <h1 className="font-serif text-[26px] font-normal leading-[1.2] tracking-tight text-white sm:text-[36px] lg:text-[44px]">
                東京のマネージドサービス：ビジネスを支えるIT運用
              </h1>
              <p className="mt-4 text-sm leading-relaxed text-gray-200 sm:text-base/7 lg:mt-5 lg:text-lg/7">
                インフラ、セキュリティ、日常のIT運用をAKRINが担当。お客様のチームは本業に集中できます。
              </p>
              <div className="mt-8 flex flex-wrap gap-4">
                <Link
                  href="/contact"
                  className="inline-flex items-center justify-center rounded-md bg-white px-5 py-2.5 text-base font-medium text-[#0A0B19] transition-colors hover:bg-gray-100"
                >
                  お問い合わせ
                </Link>
                <Link
      ...
      <div className="h-px bg-gradient-to-r from-transparent via-[#0A0B19]/[0.05] to-transparent" aria-hidden="true" />
      ...
      <div className="relative mx-auto max-w-[1400px] overflow-visible px-6 lg:px-8">
        <div className="overflow-visible lg:flex lg:items-start lg:gap-12">
          ...
          <div className="min-w-0 flex-1">
            <section id="overview" className="bg-[#F7F7FC]">
              <RevealOnScroll>
                <div className="py-20 sm:py-28">
                  ...
                  <div className="mt-8 max-w-4xl space-y-6 text-base leading-relaxed text-[#0A0B19]/80">
                    <p>
                  ...
                  <div className="mt-14 rounded-2xl border border-[#0A0B19]/10 bg-white p-8 sm:p-10">
                    <h3 className="font-serif text-2xl font-light tracking-[-0.04em] text-[#0A0B19] sm:text-3xl">
                      東京の企業がマネージドサービスを選ぶ理由
                    </h3>

                    <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-2">
                      <article className="rounded-xl border border-[#0A0B19]/10 bg-[#FAFAFC] p-6">
                        <UserGroupIcon className="h-10 w-10 stroke-[1.2] text-[#0A0B19]/70" />
                        <h4 className="mt-4 text-lg font-semibold text-[#0A0B19]">IT人材不足</h4>
                        <p className="mt-2 text-sm leading-relaxed text-[#0A0B19]/75">
                          東京の85%の企業がIT人材採用に苦戦しています。MSPに委託することで採用ボトルネックを解消し、初日からフルチームで運用を開始できます。
                        </p>
                      </article>

                      <article className="rounded-xl border border-[#0A0B19]/10 bg-[#FAFAFC] p-6">
                        <ShieldCheckIcon className="h-10 w-10 stroke-[1.2] text-[#0A0B19]/70" />
                        <h4 className="mt-4 text-lg font-semibold text-[#0A0B19]">規制対応の負担</h4>
                        <p className="mt-2 text-sm leading-relaxed text-[#0A0B19]/75">
                      ...
                      <article className="rounded-xl border border-[#0A0B19]/10 bg-[#FAFAFC] p-6">
                        <GlobeAltIcon className="h-10 w-10 stroke-[1.2] text-[#0A0B19]/70" />
                        <h4 className="mt-4 text-lg font-semibold text-[#0A0B19]">バイリンガル対応</h4>
                        <p className="mt-2 text-sm leading-relaxed text-[#0A0B19]/75">
                      ...
                      <article className="rounded-xl border border-[#0A0B19]/10 bg-[#FAFAFC] p-6">
                        <BanknotesIcon className="h-10 w-10 stroke-[1.2] text-[#0A0B19]/70" />
                        <h4 className="mt-4 text-lg font-semibold text-[#0A0B19]">コスト最適化</h4>
                        <p className="mt-2 text-sm leading-relaxed text-[#0A0B19]/75">
                    ...
                    <p className="mt-8 text-base leading-relaxed text-[#0A0B19]/80">
            ...
            <section id="monitoring" className="bg-[#F7F7FC]">
              <RevealOnScroll>
                <div className="py-20 sm:py-28">
                  ...
                  <p className="mt-8 max-w-4xl text-base leading-relaxed text-[#0A0B19]/80">
                    AKRINのマネージドサービスは継続監視から始まります。オペレーションセンターがサーバー、ネットワーク、エンドポイント、クラウド環境を24時間体制で監視し、異常を検知して業務影響前に解決します。
                  </p>

                  <div className="mt-12 divide-y divide-[#0A0B19]/10">
                    {monitoringFeatures.map((feature) => {
                      const Icon = feature.icon
                      return (
                        <div
                          key={feature.title}
                          className="-mx-4 grid grid-cols-1 gap-3 rounded-xl px-4 py-8 transition-colors duration-200 first:pt-4 last:pb-4 hover:bg-white md:grid-cols-[280px_1fr] md:-mx-6 md:gap-12 md:px-6"
                        >
                          <div className="flex items-center gap-4">
                            <Icon className="h-8 w-8 shrink-0 stroke-[1.2] text-[#0A0B19]/60" />
                            <h3 className="text-base font-semibold text-[#0A0B19]">
                              {feature.title}
                            </h3>
                          </div>
                          <p className="text-sm leading-relaxed text-[#0A0B19]/70 md:pt-1">
                            {feature.description}
                          </p>
                        </div>
                      )
                  ...
                  <p className="mt-10 max-w-4xl text-base leading-relaxed text-[#0A0B19]/80">
            ...
            <section id="help-desk" className="bg-[#F7F7FC]">
              <RevealOnScroll>
                <div className="py-20 sm:py-28">
            ...
            <section id="infrastructure" className="bg-[#F7F7FC]">
              <RevealOnScroll>
                <div className="py-20 sm:py-28">
                  ...
                  <div className="mt-10 grid grid-cols-1 gap-4 md:grid-cols-3">
                    <article className="rounded-xl border border-[#0A0B19]/10 bg-white p-6">
                      <h3 className="text-lg font-semibold text-[#0A0B19]">サーバー管理</h3>
                      <ul className="mt-4 space-y-2 text-sm leading-relaxed text-[#0A0B19]/75">
                    ...
                    <article className="rounded-xl border border-[#0A0B19]/10 bg-white p-6">
                      <h3 className="text-lg font-semibold text-[#0A0B19]">ネットワーク管理</h3>
                      <ul className="mt-4 space-y-2 text-sm leading-relaxed text-[#0A0B19]/75">
                        <li>- WAN/LAN設計・最適化</li>
                    ...
                    <article className="rounded-xl border border-[#0A0B19]/10 bg-white p-6">
                      <h3 className="text-lg font-semibold text-[#0A0B19]">クラウドオペレーション</h3>
                      <ul className="mt-4 space-y-2 text-sm leading-relaxed text-[#0A0B19]/75">
                  ...
                  <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
                    <article className="rounded-xl border border-[#0A0B19]/10 bg-white p-6">
                      <h3 className="text-lg font-semibold text-[#0A0B19]">エンドポイントセキュリティ</h3>
                      <ul className="mt-4 space-y-2 text-sm leading-relaxed text-[#0A0B19]/75">
                        <li>- デバイス保護・EDR</li>
                        <li>- リアルタイム脅威監視</li>
                    ...
                    <article className="rounded-xl border border-[#0A0B19]/10 bg-white p-6">
                      <h3 className="text-lg font-semibold text-[#0A0B19]">コンプライアンス管理</h3>
                      <ul className="mt-4 space-y-2 text-sm leading-relaxed text-[#0A0B19]/75">
            ...
            <section id="security" className="bg-[#F7F7FC]">
              <RevealOnScroll>
                <div className="py-20 sm:py-28">
                  ...
                  <div className="rounded-2xl border border-[#0A0B19]/20 bg-[#0A0B19]/[0.06] p-8 sm:p-10">
                    <h2 className="font-serif text-4xl font-light tracking-[-0.04em] text-[#0A0B19] sm:text-5xl">
                      セキュリティサービス
                    </h2>

                    <div className="mt-8 space-y-6 text-base leading-relaxed text-[#0A0B19]/80">
                      <p>
            ...
            <section id="continuity" className="bg-[#F7F7FC]">
              <RevealOnScroll>
                <div className="py-20 sm:py-28">
            ...
            <section id="planning" className="bg-[#F7F7FC]">
              <RevealOnScroll>
                <div className="py-20 sm:py-28">
                  ...
                  <div className="mt-10 grid grid-cols-1 gap-8 lg:grid-cols-5">
                    <div className="space-y-4 lg:col-span-3">
                      <article className="rounded-xl border border-[#0A0B19]/10 bg-white p-6">
                        <p className="font-mono text-xs uppercase tracking-[0.14em] text-[#0A0B19]">
                          Step 1
                        </p>
                        <h3 className="mt-2 text-xl font-semibold text-[#0A0B19]">
                          テクノロジーアセスメント
                        </h3>
                        <p className="mt-3 text-sm leading-relaxed text-[#0A0B19]/75">
            ...
            <section id="partnership" className="bg-[#F7F7FC]">
              <RevealOnScroll>
                <div className="py-20 sm:py-28">
                  ...
                  <div className="mt-10 grid grid-cols-1 gap-10 lg:grid-cols-2 lg:items-start">
                    <div>
                      <p className="text-base leading-relaxed text-[#0A0B19]/80">
                      ...
                      <div className="mt-8 space-y-4">
                        {partnershipValues.map((value) => (
                          <div key={value} className="flex items-start gap-3">
                            <CheckCircleIcon className="mt-0.5 h-5 w-5 shrink-0 stroke-[1.2] text-[#0A0B19]/70" />
                            <p className="text-sm leading-relaxed text-[#0A0B19]/80">{value}</p>
                          </div>
                        ))}
                      </div>
                      ...
                      <p className="mt-6 text-base leading-relaxed text-[#0A0B19]/80">
              ...
              <RevealOnScroll>
                <div className="py-20 sm:py-28">
                  <div className="max-w-4xl">
                    ...
                    <dl className="mt-16 divide-y divide-[#0A0B19]/10">
                      {faqItems.map((item) => (
                        <Disclosure
                          key={item.question}
                          as="div"
                        ...
                        >
                          ...
                          <DisclosurePanel as="dd" className="mt-2 pr-12">
                            <p className="text-base/7 text-[#0A0B19]/70">{item.answer}</p>
                          </DisclosurePanel>
                        </Disclosure>
                      ))}
                    </dl>
      ...
      <section className="bg-[#F7F7FC]" id="cta">
        <div className="px-6 py-20 sm:py-28 lg:px-8">
          <div className="mx-auto max-w-7xl">
            <div className="rounded-xl border border-[#0A0B19]/10 bg-white px-6 py-16 text-center sm:px-10">
              <h2 className="font-serif text-2xl font-light tracking-[-0.04em] text-[#0A0B19] sm:text-3xl">
                IT運用の変革を始めませんか？
              </h2>
              <p className="mx-auto mt-4 max-w-2xl text-base/7 text-[#0A0B19]/80">
