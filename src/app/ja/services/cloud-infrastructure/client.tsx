      ...
      <div className="bg-white font-sans">
              ...
              <div>
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-start space-x-4">
                    ...
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">現行インフラの評価とマッピング</span>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">アプリケーション依存関係の分析</span>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">コスト・ベネフィット分析とROIモデリング</span>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">移行戦略の提言</span>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">リスク評価と緩和計画</span>
                  </div>
                </div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="order-1 lg:order-2">
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">リフト&シフト移行戦略</span>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">アプリケーションのリファクタリング/近代化</span>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">CI/CD パイプライン実装</span>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">IaC (Terraform/Bicep)</span>
                  </div>
                  <div className="flex items-start space-x-4">
                    <div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div>
                    <span className="text-[#2D2E3F] text-lg leading-relaxed">データ移行と検証</span>
                  </div>
                </div>
                <p className="text-[#6B6D7C] leading-relaxed">
        ...
        <div className="bg-[#F8F9FA] py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl lg:text-5xl font-bold text-[#2D2E3F] mb-6 leading-tight">24/7 マネージドクラウド運用</h2>
            ...
            <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-8 mb-16">
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-[#2D2E3F] mb-4">24/7 モニタリング</h3>
                <ul className="text-[#6B6D7C] space-y-2 text-left">
                  <li className="flex items-start space-x-2"><div className="w-1.5 h-1.5 bg-[#0A0B19] rounded-full mt-2 flex-shrink-0"></div><span>パフォーマンス監視</span></li>
                  <li className="flex items-start space-x-2"><div className="w-1.5 h-1.5 bg-[#0A0B19] rounded-full mt-2 flex-shrink-0"></div><span>可用性アラート</span></li>
                  <li className="flex items-start space-x-2"><div className="w-1.5 h-1.5 bg-[#0A0B19] rounded-full mt-2 flex-shrink-0"></div><span>SLAレポート</span></li>
                </ul>
              </div>
              <div className="text-center">
                <div className="w-20 h-20 bg-[#0A0B19] rounded-full flex items-center justify-center mx-auto mb-6">
                ...
                <h3 className="text-xl font-bold text-[#2D2E3F] mb-4">セキュリティ運用</h3>
                <ul className="text-[#6B6D7C] space-y-2 text-left">
                  <li className="flex items-start space-x-2"><div className="w-1.5 h-1.5 bg-[#0A0B19] rounded-full mt-2 flex-shrink-0"></div><span>脅威検知と対応</span></li>
                  <li className="flex items-start space-x-2"><div className="w-1.5 h-1.5 bg-[#0A0B19] rounded-full mt-2 flex-shrink-0"></div><span>ポリシー準拠</span></li>
                  <li className="flex items-start space-x-2"><div className="w-1.5 h-1.5 bg-[#0A0B19] rounded-full mt-2 flex-shrink-0"></div><span>監査ログ管理</span></li>
                </ul>
              </div>
              <div className="text-center">
                <div className="w-20 h-20 bg-[#0A0B19] rounded-full flex items-center justify-center mx-auto mb-6">
                ...
                <h3 className="text-xl font-bold text-[#2D2E3F] mb-4">SRE/運用最適化</h3>
                <ul className="text-[#6B6D7C] space-y-2 text-left">
                  <li className="flex items-start space-x-2"><div className="w-1.5 h-1.5 bg-[#0A0B19] rounded-full mt-2 flex-shrink-0"></div><span>自動化とオートスケール</span></li>
                  <li className="flex items-start space-x-2"><div className="w-1.5 h-1.5 bg-[#0A0B19] rounded-full mt-2 flex-shrink-0"></div><span>パフォーマンス最適化</span></li>
                  <li className="flex items-start space-x-2"><div className="w-1.5 h-1.5 bg-[#0A0B19] rounded-full mt-2 flex-shrink-0"></div><span>ランブック/インシデント対応</span></li>
                </ul>
              </div>
              <div className="text-center">
                <div className="w-20 h-20 bg-[#0A0B19] rounded-full flex items-center justify-center mx-auto mb-6">
                ...
                <h3 className="text-xl font-bold text-[#2D2E3F] mb-4">FinOps/コスト最適化</h3>
                <ul className="text-[#6B6D7C] space-y-2 text-left">
                  <li className="flex items-start space-x-2"><div className="w-1.5 h-1.5 bg-[#0A0B19] rounded-full mt-2 flex-shrink-0"></div><span>リザーブド/セービングプラン</span></li>
                  <li className="flex items-start space-x-2"><div className="w-1.5 h-1.5 bg-[#0A0B19] rounded-full mt-2 flex-shrink-0"></div><span>適正サイジング</span></li>
                  <li className="flex items-start space-x-2"><div className="w-1.5 h-1.5 bg-[#0A0B19] rounded-full mt-2 flex-shrink-0"></div><span>コスト可視化レポート</span></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                <h2 className="text-4xl lg:text-5xl font-bold text-[#2D2E3F] mb-6 leading-tight">クラウド変革パートナー</h2>
                <p className="text-lg text-[#6B6D7C] mb-8 leading-relaxed">
                  成功するクラウド戦略には、専門知識・計画・継続的な最適化が不可欠です。当社のソリューションはビジネスニーズに合わせて進化し、スケーラブルで安全かつコスト効率的な運用を提供します。
                </p>
                <div className="space-y-4">
                  <div className="flex items-start space-x-4"><div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div><span className="text-[#2D2E3F] text-lg leading-relaxed">実証済みの方法論で確実な成果</span></div>
                  <div className="flex items-start space-x-4"><div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div><span className="text-[#2D2E3F] text-lg leading-relaxed">スタートアップから大企業まで対応</span></div>
                  <div className="flex items-start space-x-4"><div className="w-2 h-2 bg-[#0A0B19] rounded-full mt-3 flex-shrink-0"></div><span className="text-[#2D2E3F] text-lg leading-relaxed">セキュリティとコンプライアンスを堅持</span></div>
                </div>
              </div>
              <div>
                <Image
        ...
        <div className="bg-[#0A0B19] py-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-4 leading-tight">インフラをモダナイズする準備はできていますか？</h2>
            <p className="text-base text-white/90 mb-6 max-w-4xl mx-auto leading-relaxed">200社以上の企業がAKRINをクラウド変革のパートナーとして選んでいます。SMB向け価格でエンタープライズグレードのクラウドを。</p>
            <Link href="/ja/contact" className="inline-flex items-center px-6 py-2.5 bg-white text-[#0A0B19] font-semibold text-sm rounded-sm hover:bg-gray-100 transition-all duration-200 shadow-lg hover:shadow-xl">クラウドジャーニーを開始</Link>
          </div>
        </div>
