...
type Item = { title: string; body?: string; description?: string; icon: React.ReactNode }
...
function IconCircle({ children }: { children: React.ReactNode }) {
  return (
    <span
      aria-hidden="true"
      className="inline-flex h-12 w-12 md:h-14 md:w-14 items-center justify-center rounded-full bg-[#0A0B19]/15 text-[#0A0B19]"
    >
      <svg
        viewBox="0 0 24 24"
...
export default function CapabilityCards({ items = defaultItems }: CapabilityCardsProps) {
  return (
          ...
          {items.map((it, i) => (
            <article
              ...
              className={[
                ...
                i === 1
                  ? "border-[#0A0B19] ring-1 ring-[rgba(23,16,14,0.28)] shadow-md"
                  : "",
                ...
                "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0A0B19] focus-visible:ring-offset-2 focus-visible:ring-offset-white",
