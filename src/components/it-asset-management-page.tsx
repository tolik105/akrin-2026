...
export function ItAssetManagementPage({ locale }: { locale: Locale }) {
  ...
  return (
    <main className="overflow-x-clip bg-white">
            ...
            <div className="rounded-3xl border border-white/15 bg-[#0b1b42] p-6 shadow-2xl">
              ...
              <div className="mt-8 space-y-4">
                <div className="h-2 rounded-full bg-white/15">
                  <div className="h-2 w-11/12 rounded-full bg-[#0A0B19]" />
                </div>
                <div className="h-2 rounded-full bg-white/15">
        ...
        <Container>
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mt-10 grid gap-10 lg:grid-cols-2">
              ...
              <div className="rounded-2xl border border-gray-200 bg-[#FAFAFC] p-6">
      ...
      <section id="benefits" className="bg-[#FAFAFC] py-20 sm:py-24">
        <Container>
          <div className="mx-auto max-w-6xl">
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
              {content.services.map((item) => (
                <article key={item.title} className="rounded-2xl border border-gray-200 bg-[#FAFAFC] p-6">
      ...
      <section id="process" className="bg-[#FAFAFC] py-20 sm:py-24">
        <Container>
          <div className="mx-auto max-w-6xl">
            <h2 className="text-3xl font-semibold tracking-tight text-gray-950 sm:text-4xl">
      ...
      <section id="industries" className="bg-[#FAFAFC] py-20 sm:py-24">
        <Container>
          <div className="mx-auto max-w-6xl">
            <h2 className="text-3xl font-semibold tracking-tight text-gray-950 sm:text-4xl">
